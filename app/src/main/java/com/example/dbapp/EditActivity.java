...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerBookId = findViewById(R.id.spinner_car_id);
        editTextBookName = findViewById(R.id.edit_text_car_name);
        editTextBookAuthor = findViewById(R.id.edit_text_car_mark);
    ...
    private void updateBook() {
        ...
        if (result > 0) {
            Toast.makeText(this, "Car update", Toast.LENGTH_SHORT).show();
            finish();
        } else {
