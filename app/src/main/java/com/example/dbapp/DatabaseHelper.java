...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "car_db"; // Название БД
    private static final int SCHEMA = 2; // Версия БД
    static final String TABLE_NAME = "cars"; // Имя таблицы
    public static final String COLUMN_ID = "id_cars";
    public static final String COLUMN_NAME = "cars_name";
    public static final String COLUMN_AUTHOR = "cars_mark";
